...
<%
	List<Resource> resources = (List<Resource>) request.getAttribute("showFull");
%>
<!DOCTYPE html>
<html lang="en">
			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					...
					data-toggle="collapse" href="#coll0" aria-expanded="false"> <i
						class="fa fa-fw fa-comments"></i> <span class="nav-link-text">Roles</span>
				</a>
					<ul class="sidenav-second-level collapse" id="coll0">
						<li><a href="/role">List</a></li>
						<li><a href="/role/add">Add</a></li>
					</ul>
				</li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					<a class="nav-link nav-link-collapse collapsed"
					data-toggle="collapse" href="#coll1" aria-expanded="false"> <i
						class="fa fa-fw fa-sign-in"></i> <span class="nav-link-text">User</span>
				</a>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					...
					data-toggle="collapse" href="#coll2" aria-expanded="false"> <i
						class="fa fa-fw fa-list"></i> <span class="nav-link-text">Access</span>
				</a>
					<ul class="sidenav-second-level collapse" id="coll2">
						<li><a href="/access">List</a></li>
						<li><a href="/access/add">Add</a></li>
					</ul>
				</li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					<a class="nav-link nav-link-collapse collapsed"
					data-toggle="collapse" href="#coll3" aria-expanded="false"> <i
						class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Pension</span>
				</a>
					<ul class="sidenav-second-level collapse" id="coll3">
						<li><a href="/pension">List</a></li>
						<li><a href="/pension/add">Add</a></li>
					</ul>
				</li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					<a class="nav-link nav-link-collapse collapsed"
					data-toggle="collapse" href="#coll4" aria-expanded="false"> <i
						class="fa fa-fw fa-link"></i> <span class="nav-link-text">Resource</span>
				</a>
							...
							<tbody>
								<%
									for (int idx = 0; idx < resources.size(); idx++) {
										Resource t = (Resource) resources.get(idx);
								%>
								<tr>
									<td><%=t.getId()%></td>
									<td><%=t.getName()%></td>
									<td><%=t.isStatus()%></td>
									<td><%=t.getDate()%></td>
									<td><a href="/resource/view?ID=<%=t.getId()%>">View </a><a
										href="/resource/edit?ID=<%=t.getId()%>">Edit </a><a
										href="/resource/delete?ID=<%=t.getId()%>">Delete </a></td>
								</tr>
								<%
									}
								%>
