...
<%
	List<Role> roles = (List<Role>) request.getAttribute("showFull");
%>
<!DOCTYPE html>
<html lang="en">
						...
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><%=t.getDate()%></td>
									<td><%=t.isStatus()%></td>
									<td><a href="/role/view?ID=<%=t.getId()%>">View</a><a
										href="/role/edit?ID=<%=t.getId()%>">Edit</a><a
										href="/role/delete?ID=<%=t.getId()%>">Delete</a></td>
								</tr>
								<%
									}
								%>
