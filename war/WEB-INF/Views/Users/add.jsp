				...
				<form action="/user/add" method="get">
					<fieldset>
						...
						out.print("selected");%>><%=roles.get(i).getName()%></option>
							...
							%>
						</select> <input type="email" name="email" placeholder="Email" /> <input
							type="radio" name="gender" value="true" checked> Male<br>
						<input type="radio" name="gender" value="false"> Female<br>
						<input type="date" name="date" value="2000-01-01" /> <input
